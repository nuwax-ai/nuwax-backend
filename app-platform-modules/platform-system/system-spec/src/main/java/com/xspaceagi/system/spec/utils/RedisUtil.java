...
public class RedisUtil {
    ...
    public void hashDelete(String key, String hkey) {
...
//        redisTemplate.opsForList().leftPushAll(key,"w","x","y");
    ...
    public boolean lock(String key, long timeoutMillis) {
        ...
        while (System.currentTimeMillis() - startTime < timeoutMillis) {
            Boolean success = redisTemplate.opsForValue().setIfAbsent(key, "locked", timeoutMillis, TimeUnit.MILLISECONDS);
            ...
            try {
                ...
                return false; // 被中断，返回失败
            }
        }
        return false; // 超过等待时间，未能获取锁
    }
