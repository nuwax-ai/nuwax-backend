...
public class TenantCreatedTaskServiceImpl extends AbstractTaskExecuteService {
        ...
        while (val != null) {
            ...
            try {
                ...
                if (CollectionUtils.isNotEmpty(userDtos)) {
                    ...
                    UserDto user = userApplicationService.queryById(userId);
                    ...
                    if (CollectionUtils.isNotEmpty(spaceDtos)) {
                        ...
                        agentConfigDto.setIcon("https://s3.nuwax.com:9443/nuwax-public/icons/v3-release-icons/f3a054502d644226ae50afa2d5f766c7.png");
                        ...
                        tenantConfig.setRecommendAgentIds(longs);
    ...
    private Long addAndPublishAgent(Long spaceId, AgentConfigDto agentConfigDto) {
    ...
    private Long initViralCopywriting(Long tenantId, Long userId, Long spaceId) {
        ...
        agentConfigDto.setIcon("https://s3.nuwax.com:9443/nuwax-public/icons/v3-release-icons/0298de4879674015a494a250098acf74.png");
    ...
    private Long initPsychologicalModelExpert(Long tenantId, Long userId, Long spaceId) {
        ...
        agentConfigDto.setIcon("https://s3.nuwax.com:9443/nuwax-public/icons/v3-release-icons/685bbcbaac374f0b9dda7c3ab33fb491.png");
    ...
    private Long initPromptExpert(Long tenantId, Long userId, Long spaceId) {
        ...
        agentConfigDto.setIcon("https://s3.nuwax.com:9443/nuwax-public/icons/v3-release-icons/e43ec401e8bc428ea6101bac1a90791d.png");
