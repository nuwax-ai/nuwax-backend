...
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicCacheStrategy;
...
public class AnthropicCacheOptions {
	 ...
	 * prompts. Defaults to {@link com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicCacheTtl#FIVE_MINUTES}. Note that different
	 ...
	 */
	private Map<MessageType, com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicCacheTtl> messageTypeTtl = Stream.of(MessageType.values())
		.collect(Collectors.toMap(mt -> mt, mt -> com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicCacheTtl.FIVE_MINUTES, (m1, m2) -> m1, HashMap::new));
	...
	public Map<MessageType, com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicCacheTtl> getMessageTypeTtl() {
		return this.messageTypeTtl;
	}

	public void setMessageTypeTtl(Map<MessageType, com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicCacheTtl> messageTypeTtl) {
	...
	public static final class Builder {
		...
		public Builder messageTypeTtl(Map<MessageType, com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicCacheTtl> messageTypeTtl) {
