...
public final class CitationDocument {
	 ...
	 */
	public com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock toContentBlock() {
		com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock.Source source = createSource();
		return new com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock(source, this.title, this.context, this.citationsEnabled, null);
	}

	private com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock.Source createSource() {
		return switch (this.type) {
			case PLAIN_TEXT ->
				new com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock.Source("text", "text/plain", (String) this.sourceData, null, null);
			case PDF -> {
				String base64Data = Base64.getEncoder().encodeToString((byte[]) this.sourceData);
				yield new com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock.Source("base64", "application/pdf", base64Data, null, null);
			}
			case CUSTOM_CONTENT -> {
				@SuppressWarnings("unchecked")
				List<com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock> content = (List<com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock>) this.sourceData;
				yield new com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock.Source("content", null, null, null, content);
			}
		};
	}
	...
	public static class Builder {
		 ...
		 * @return Builder for method chaining
		 */
		public Builder customContent(List<com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock> contentBlocks) {
		...
		public Builder customContent(String... textBlocks) {
			...
			List<com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock> blocks = Arrays.stream(textBlocks)
