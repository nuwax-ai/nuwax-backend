...
package com.xspaceagi.agent.core.infra.component.model.anthropic.api;
...
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ChatCompletionResponse;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlock.Type;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockDeltaEvent;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockDeltaEvent.ContentBlockDeltaJson;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockDeltaEvent.ContentBlockDeltaSignature;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockDeltaEvent.ContentBlockDeltaText;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockDeltaEvent.ContentBlockDeltaThinking;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockStartEvent;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockStartEvent.ContentBlockText;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockStartEvent.ContentBlockThinking;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ContentBlockStartEvent.ContentBlockToolUse;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.EventType;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.MessageDeltaEvent;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.MessageStartEvent;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.Role;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.StreamEvent;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.ToolUseAggregationEvent;
import com.xspaceagi.agent.core.infra.component.model.anthropic.api.AnthropicApi.Usage;
...
public class StreamHelper {
	...
	public boolean isToolUseStart(StreamEvent event) {
		...
		return Type.TOOL_USE.getValue().equals(((ContentBlockStartEvent) event).contentBlock().type());
	}
	...
	public StreamEvent mergeToolUseEvents(StreamEvent previousEvent, StreamEvent event) {
		...
		if (event.type() == EventType.CONTENT_BLOCK_START) {
			...
			if (Type.TOOL_USE.getValue().equals(contentBlockStart.contentBlock().type())) {
			...
			if (Type.INPUT_JSON_DELTA.getValue().equals(contentBlockDelta.delta().type())) {
			...
			if (!eventAggregator.getToolContentBlocks().isEmpty()) {
				return eventAggregator;
			}
		}
		...
		if (event.type().equals(EventType.MESSAGE_START)) {
			...
			if (!CollectionUtils.isEmpty(eventToolUseBuilder.getToolContentBlocks())) {
				...
				List<ContentBlock> content = eventToolUseBuilder.getToolContentBlocks()
					...
					.toList();
				contentBlockReference.get().accumulateContent(content);
			}
		}
	...
	public static class ChatCompletionResponseBuilder {
		...
		public ChatCompletionResponseBuilder accumulateContent(List<ContentBlock> newContent) {
			List<ContentBlock> mutable = new ArrayList<>();
			if (this.content != null) {
				mutable.addAll(this.content);
			}
			mutable.addAll(newContent);
