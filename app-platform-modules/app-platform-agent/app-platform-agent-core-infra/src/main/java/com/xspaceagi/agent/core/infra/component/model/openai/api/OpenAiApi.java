...
public class OpenAiApi {
    ...
    public record ChatCompletionMessage(// @formatter:off
        ...
        public record MediaContent(// @formatter:off
			...
			@JsonProperty("image_url") ImageUrl imageUrl, @JsonProperty("video_url") VideoUrl videoUrl,
            ...
            public MediaContent(VideoUrl videoUrl) {
                this("video_url", null, null, videoUrl, null, null);
            }
            ...
            public MediaContent(InputAudio inputAudio) {
                this("input_audio", null, null, null, inputAudio, null);
            }
            ...
            public MediaContent(InputFile inputFile) {
                this("file", null, null, null, null, inputFile);
            }
            ...
            @JsonInclude(Include.NON_NULL)
            public record VideoUrl(@JsonProperty("url") String url, @JsonProperty("detail") String detail) {
