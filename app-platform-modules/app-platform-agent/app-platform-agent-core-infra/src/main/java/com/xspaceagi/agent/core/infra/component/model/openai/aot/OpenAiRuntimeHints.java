...
package com.xspaceagi.agent.core.infra.component.model.openai.aot;

import java.util.Set;

import com.xspaceagi.agent.core.infra.component.model.openai.api.OpenAiApi;
import com.xspaceagi.agent.core.infra.component.model.openai.api.OpenAiEmbeddingDeserializer;
...
public class OpenAiRuntimeHints implements RuntimeHintsRegistrar {
	...
	public void registerHints(@NonNull RuntimeHints hints, @Nullable ClassLoader classLoader) {
		...
		for (var tr : findJsonAnnotatedClassesInPackage("com.xspaceagi.agent.core.infra.component.model.openai")) {
